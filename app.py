...
import numpy as np
from ipywidgets import interact, widgets  # เพิ่มตัวนี้สำหรับ Drop-box

# ==========================================
# 1. FUNCTION WRAPPER (เพื่อให้ Interactive ได้)
# ==========================================
def update_beam_design(fc_prime_val):
    # --- ดึงค่าจาก input เดิม (คงที่) ---
    fc_prime = fc_prime_val  # รับจาก Drop-box
    fy = 4000            
    span_cc = 6.40       
    col_left_w = 0.40    
    col_right_w = 0.50   
    ...
    # --- ส่วนการวาดรูป (Nested Functions) ---
    ...
    res_txt = (f"ACI 318-19 Anchorage: f'c = {fc_prime} ksc, Main Bar = DB{db_mm}\n"
               f"Ld = {ld_m:.3f} m. | Ldh (90 Hook) = {ldh_m:.3f} m.")
...
# ==========================================
# 4. [CREATE DROP-BOX INTERFACE]
# ==========================================
interact(update_beam_design, 
         fc_prime_val=widgets.Dropdown(
