...
# Main Bar Size Dropdown (DB-mm) - เปลี่ยนเป็น Selectbox ตามที่ต้องการ
...
st.caption("Developed by Ardharn 2026")
    ...
    ax0.set_title(f"LONGITUDINAL SECTION (f'c={fc_ksc} ksc, fy={fy_choice} ksc)", fontsize=15, weight='bold', pad=30)
